    ...
    >
      ...
      {recoveredItems.length === 0 ? (
        ...
        <>
          {/* Table Layout */}
          {isTableLayout ? (
            <div className="overflow-x-auto shadow-[0px_0px_20px_#f3f3f3] rounded-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {recoveredItems.map((item) => (
                <motion.div
                  ...
                  className="border border-secondary rounded-xl p-5 shadow hover:shadow-lg transition-all"
                >
